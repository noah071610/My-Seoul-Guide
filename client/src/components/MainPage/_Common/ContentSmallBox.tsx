...
const ContentSmallBox = observer(
  ({ onClickAirport }: { onClickAirport: (number: number) => void }) => {
    return (
      <div style={{ display: "flex" }}>
        <div onClick={() => onClickAirport(1)} className="content_small_box">
          <h2>
        ...
        <div onClick={() => onClickAirport(2)} className="content_small_box">
          <h2>
