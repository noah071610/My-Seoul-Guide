...
import MapModal from "./ManualModals/MapModal";
import MenuModal from "./ManualModals/MenuModal";
import PlaceModal from "./ManualModals/PlaceModal";
import ActivityModal from "./ManualModals/ActivityModal";
